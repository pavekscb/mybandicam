...
![Latest](https://img.shields.io/github/downloads/USERNAME/REPOSITORY/latest/total)
...
## 📌 TODO (можешь оставить или удалить)
...
Если хочешь — могу сделать тебе **README уровня топ-репозиториев (как у open-source проектов с 10k⭐)** с гифками, превью и демо 🚀
